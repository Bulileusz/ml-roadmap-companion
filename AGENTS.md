...
- **Treść jest content-only**: nowe fiszki, pytania i materiały wchodzą wyłącznie z `content/`. Aplikacja pozwala je edytować i usuwać, ale nie dodawać — nie proponuj przycisku dodawania.
