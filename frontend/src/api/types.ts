...
export type QuestionStats = Schemas['QuestionStats']
...
export type DayPhase = Schemas['DayPhase']
export type DayNote = Schemas['DayNote']
export type BackupPreview = Schemas['BackupPreview']
export type BackupImportResult = Schemas['BackupImportResult']
export type SessionPlan = Schemas['SessionPlan']
export type Briefing = Schemas['Briefing']
export type QuestionsGate = Schemas['QuestionsGate']
